...
class West
{
    ...
    {
        $tile = $this->engine->getTileOnMapPosition($client->getUser()->getMapPosition()->moveLeft());
        ...
        return call(function () use ($client, $tile) {
            yield $this->engine->moveClient($client, $client->getUser()->getMapPosition()->moveLeft(), 'west');
