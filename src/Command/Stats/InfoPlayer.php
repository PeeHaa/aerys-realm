...
use PeeHaa\AerysRealmII\Controller\Stats\InfoPlayer as Controller;
use PeeHaa\AerysRealmII\Request\Request;

class InfoPlayer extends Command
{
    ...
    {
        return $request->isCommand('info') && $request->hasNumberOfParameters(1);
    }
}
